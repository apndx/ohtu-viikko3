...
public class Stepdefs {
    ...
    public void login_system_will_respond_with(String expectedOutput) throws Throwable {
    ...
    public void user_with_password_is_created(String user, String pass) throws Throwable {
        inputLines.add("new");
        inputLines.add(user);
        inputLines.add(pass);
